...
// Segment mapping layout: {bottom: 0, mid: 1, top: 2, L-lower: 3, L-upper: 4,
// R-lower: 5, R-upper: 6}
...
/**
 * @brief Converts a character (with case-insensitivity) to its 7-segment
 * representation.
...
/**
 * @brief Sanitizes an input string by replacing unsupported characters with
 * spaces.
 */
